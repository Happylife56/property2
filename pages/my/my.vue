			...
			<scroll-view scroll-y="true" class="contenter-scroll">
				...
				<view class="cu-list menu-avatar">
					...
					<view class="cu-item cu-item-green">
						...
						<view class="action" @click="viewSetting">
							<text class="text-xxl">
					...
					<!-- 宫格 -->
					<list :datas="keepList" bg="green"></list>
				</view>
				<!-- 钱包 积分 -->
				<list :datas="walletPoints" class="cu-list-money"></list>
				<!-- 我的订单 -->
				<view class="my-order">
					...
					<list :datas="orderList" :col="5" class="cu-list-money"></list>
				</view>
				<!-- 功能列表 -->
				<view class="cu-list menu margin-top">
					<view class="cu-item" v-for="(item,index) in functionList" :key="index" @click="navigatePath(index)">
						<view class="content">
