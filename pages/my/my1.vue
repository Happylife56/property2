    ...
    <view class="center content">
      ...
      >
        ...
        <view class="logo-title">
          <view class="column-center user-column">
            <text class="uer-name text-cut">Hi，{{login ? uerInfo.name : '您未登录'}}</text>
            <text
              v-if="login"
              class="text-cut"
            >会员号：{{ uerInfo.name}}</text>
          </view>
          ...
          <!-- 设置 -->
          <text class="go-login navigat-arrow"><text class="text-white cuIcon-settings"></text></text>
        </view>
      </view>
