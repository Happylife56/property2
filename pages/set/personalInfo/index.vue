			...
			<scroll-view scroll-y="true" class="contenter-scroll">
				<view class="person-info">
					<view class="cu-form-group margin-top">
						...
						<view class="img-handler">
							<view class="cu-avatar lg round margin-left" :style="'background-image:url('+imgHeader+');'"> </view>
							<text class="text-xxl" @tap="ChooseImage">
				...
				<view class="title">昵称：</view>
					...
					<view class="cu-form-group">
						...
						<input placeholder="请输入会员名" name="name" />
					</view>
					<view class="cu-form-group">
						<view class="title">会员号：</view>
						<input placeholder="请输入会员号" name="name" disabled />
					</view>
					<view class="cu-form-group">
						<view class="title">性别：</view>
						<picker @change="sexChange" :value="sex" :range="sexData">
							<view class="picker">
					...
					<view class="cu-form-group">
						...
						<input placeholder="请输入手机号码" name="name" />
					</view>
